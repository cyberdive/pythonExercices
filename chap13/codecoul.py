...
class Application:
    ...
    def signaleErreur(self):
        ...
        self.root.after(1000, self.videEntree)		# apr�s 1 seconde, effacer

    def videEntree(self):
        self.entree.configure(bg ='white')		# r�tablir le fond blanc
        self.entree.delete(0, len(self.v1ch))		# enlever les car. pr�sents
